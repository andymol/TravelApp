...
class TripComponent extends React.Component {
    ...
    handleChange(event, trip) {
        this.props.handleChange(event, trip);
    }
            ...
            <React.Fragment>
                <Form className="trip-ui">
                    ...
                    <Checkbox
                        ...
                        name={trip.title}
                        text={trip.title}
                        onChange={(event) => this.handleChange(event, trip)}
                    />

                    <Button className="col " padding="auto" trip={trip} token={token} onClick={() => this.props.triggerDelete(trip)}>Delete</Button>

                    <Button className="col " padding="auto" trip={trip} token={token} onClick={() => this.props.triggerReplicate(trip)}>Replicate</Button>
                </Form>
